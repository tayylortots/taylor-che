function Frame9() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[4px] relative rounded-[60px] shrink-0">
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[710px]">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#989898] text-[36px] w-full whitespace-pre-wrap">Resume</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[627px]">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#989898] text-[36px] w-full whitespace-pre-wrap">LinkedIn</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[627px]">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#989898] text-[36px] w-full whitespace-pre-wrap">Email</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[710px]">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#989898] text-[36px] w-full whitespace-pre-wrap">Instagram</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[710px]">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#989898] text-[36px] w-full whitespace-pre-wrap">Behance</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#989898] text-[128px] w-full whitespace-pre-wrap">Links</p>
      <Frame2 />
    </div>
  );
}
...
export default function Contact() {
  return (
    <div className="bg-[#f0f0f0] relative size-full" data-name="Contact">
